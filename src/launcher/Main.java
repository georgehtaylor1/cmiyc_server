...
public class Main {
	...
	public Main( String _arguments[] ) {
		...
		this.gui.addWindowListener( new WindowAdapter() { public void windowClosing( WindowEvent _event ) { guiExit(); } } );
	...
	private void guiExit() {
		...
		if( this.serverHandler == null ) { System.exit(0); return; }

		switch( this.serverHandler.serverState ) {
			case STOPPED : System.exit(0); return;
			case STOPPING : System.exit(0); return;
			default : this.stopServer(); System.exit(0);
		}
	...
	private void mainButtonPress() {
		...
		if( this.serverHandler == null ) { this.startServer(); return; }
		
		switch( this.serverHandler.serverState ) {
			case STOPPED : this.startServer(); break;
			case STARTED : this.stopServer(); break;
			default : return;
		}
	...
	private void startServer() {
		...
		if( !this.serverHandler.prepareStart( this.gui, this.port ) ) { return; }
	...
	public static void main( String _arguments[] ) { new Main( _arguments ); }
